...
export default function (id, change) {
    ...
    var ids = {},
      ...
      setSelector = function (hsb, cal) {
        ...
        $(cal)
          .data("colorpicker")
          .selectorIndic.css({
            left: parseInt(((150 * hsb.s) / 100).toString(), 10),
            top: parseInt(((150 * (100 - hsb.b)) / 100).toString(), 10),
          });
      },
      setHue = function (hsb, cal) {
        $(cal)
          .data("colorpicker")
          .hue.css("top", parseInt((150 - (150 * hsb.h) / 360).toString(), 10));
      },
      ...
      moveIncrement = function (ev) {
        ev.data.field.val(
          Math.max(
            ...
            Math.min(
              ev.data.max,
              parseInt((ev.data.val + ev.pageY - ev.data.y).toString(), 10)
            )
          )
        );
        if (ev.data.preview) {
      ...
      init: function (opt) {
        ...
        return this.each(function () {
          if (!$(this).data("colorpickerId")) {
            ...
            var id =
              "collorpicker_" + parseInt((Math.random() * 1000).toString());
  ...
  let colorSelector = $("#" + id) as any;
  return colorSelector.ColorPicker({
    color: "#0000ff",
